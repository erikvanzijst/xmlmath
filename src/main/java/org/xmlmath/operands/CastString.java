...
import org.xmlmath.x10.CastStringType;
import org.xmlmath.x10.ValueType;

/**
 * Use this operator to cast any value to type string. The given value must be a
 * subtype of abstract-string, or a TypeCastException will be thrown at runtime.
 *
 * @author	Erik van Zijst - erik@prutser.cx
 * @version	v1.0, 29.mar.2006
 */
public class CastString extends AbstractStringValue {
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		CastStringType xml = (CastStringType)xmlObject;
