...
import org.xmlmath.x10.CastListType;
import org.xmlmath.x10.ValueType;

/**
 * Use this operator to cast any value to type list. The given value must be a
 * subtype of abstract-list, or a TypeCastException will be thrown at runtime.
 *
 * @author	Erik van Zijst - erik@prutser.cx
 * @version	v1.0, 29.mar.2006
 */
public class CastList extends AbstractListValue {
	...
	public List<Object> getList() {
		...
		List<Object> l = (List<Object>)value.getValue();
		return l;
	}
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		CastListType xml = (CastListType)xmlObject;
