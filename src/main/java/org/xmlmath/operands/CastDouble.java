...
import org.xmlmath.x10.CastDoubleType;
import org.xmlmath.x10.ValueType;

/**
 * Use this operator to cast any value to type double. The given value must be a
 * subtype of abstract-double, or a TypeCastException will be thrown at runtime.
 *
 * @author	Erik van Zijst - erik@prutser.cx
 * @version	v1.0, 29.mar.2006
 */
public class CastDouble extends AbstractDoubleValue {
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		CastDoubleType xml = (CastDoubleType)xmlObject;
