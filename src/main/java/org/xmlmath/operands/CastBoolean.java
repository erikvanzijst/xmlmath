...
import org.xmlmath.x10.CastBooleanType;
import org.xmlmath.x10.ValueType;

/**
 * Use this operator to cast any value to type boolean. The given value must be a
 * subtype of abstract-boolean, or a TypeCastException will be thrown at runtime.
 *
 * @author	Erik van Zijst - erik@prutser.cx
 * @version	v1.0, 29.mar.2006
 */
public class CastBoolean extends AbstractBooleanValue {
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		CastBooleanType xml = (CastBooleanType)xmlObject;
