...
import org.xmlmath.x10.CastNumberType;
import org.xmlmath.x10.ValueType;

/**
 * Use this operator to cast any value to type number. The given value must be
 * a subtype of number, or a TypeCastException will be thrown at runtime.
 *
 * @author	Erik van Zijst - erik@prutser.cx
 * @version	v1.1, 04.jul.2006
 */
public class CastNumber extends AbstractNumberValue {
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		CastNumberType xml = (CastNumberType)xmlObject;
