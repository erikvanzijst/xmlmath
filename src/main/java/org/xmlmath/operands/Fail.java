...
import org.xmlmath.x10.FailType;
import org.xmlmath.x10.ValueType;

/**
 * Throws an <tt>EvaluationException</tt>, causing the evaluation to fail.
 *
 * @author	Erik van Zijst - erik@prutser.cx
 * @version	v1.1, 21.jun.2006
 */
public final class Fail extends AbstractValue {

	private String message = null;
	
	/**
	 * Throws an <tt>EvaluationException</tt>.
	 */
	@Override
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		FailType xml = (FailType)xmlObject;
		if(xml.isSetMessage()) {
