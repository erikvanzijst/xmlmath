...
import org.xmlmath.x10.InlineBooleanType;
import org.xmlmath.x10.StanzaType;
import org.xmlmath.x10.ValueType;

/**
 * Convenience tag to inline stanza's that return type <tt>Boolean</tt>.
 *
 * @author	Erik van Zijst - erik@prutser.cx
 * @version	v1.1, 12.may.2006
 */
public class InlineBoolean extends AbstractBooleanValue {

	private Stanza boolStanza = null;

	@Override
	public Boolean getBoolean() {

		try {
			return (Boolean)boolStanza.getValue();
	...
	protected void build(ValueType xmlObject) throws ParseException {
		...
		InlineBooleanType xml = (InlineBooleanType)xmlObject;
		...
		boolStanza = Stanza.parse(stanzaType);
	}
}
